...
out_fname = path_to_data + 'preprocessed/ERA5_sensitivity_test_trajectories/PRISM_HUC8_{0}_{1}_{2}_{3}Z_{4}hPa.nc'.format(HUC8_ID, event_date, ddict['grid'], h, lev_t) 
