...
dsname = 'ivt' ## 'ivt' or '700z'

### Constants ###
outdir = '/expanse/nfs/cw3e/cwp140/downloads/ERA5/{0}/'.format(dsname)
datadir = '/expanse/nfs/cw3e/cwp140/downloads/ERA5/{0}/daily/'.format(dsname)
fmt = '.nc'

print('Step 1: Reading data...')
filename_pattern = datadir + 'era5_namerica_025dg_daily_*.nc'
